 ...
 *
 * Header file containing all configurable parameters of the Magni-Silver, as for
 * example its pinout.
...
#define SYNCWORD                        0b11000000
#define PI                              3.14159265358979f
#define MINPULSE                        40000
...
#define CFG_BATT_TIMEOUT                5
#define CFG_BATT_FACTOR                 (28.0f/3)
...
#define CFG_COM_DEBUG                   7
#define CFG_COM_ENABLE                  6
#define CFG_COM_FAULTCLR                5
...
#define CFG_ECHO1_TIMBASE               WTIMER0_BASE

// Sensor 2 PB2/PE0
#define CFG_ECHO2_PORT                  GPIO_PORTC_BASE
#define CFG_ECHO2_PIN                   GPIO_PIN_6
#define CFG_TRIG2_PORT                  GPIO_PORTE_BASE
#define CFG_TRIG2_PIN                   GPIO_PIN_0
#define CFG_ECHO2_TIMBASE               WTIMER1_BASE
...
#define CFG_ECHO3_TIMBASE               WTIMER2_BASE

// Sensor 4 PD6/PD7
#define CFG_ECHO4_PORT                  GPIO_PORTD_BASE
#define CFG_ECHO4_PIN                   GPIO_PIN_2
#define CFG_TRIG4_PORT                  GPIO_PORTD_BASE
#define CFG_TRIG4_PIN                   GPIO_PIN_7
#define CFG_ECHO4_TIMBASE               WTIMER3_BASE

// Sensor 5 PA4/PB6 A6/B6 tauschen?
#define CFG_ECHO5_PORT                  GPIO_PORTD_BASE
#define CFG_ECHO5_PIN                   GPIO_PIN_6
#define CFG_TRIG5_PORT                  GPIO_PORTA_BASE
#define CFG_TRIG5_PIN                   GPIO_PIN_3
#define CFG_ECHO5_TIMBASE               WTIMER4_BASE
//#endif
#endif
...
#define CFG_JOY_XAX_ANI                 ADC_CTL_CH0

#define CFG_JOY_YAX_MOD                 ADC1_BASE
#define CFG_JOY_YAX_SSQ                 0
#define CFG_JOY_YAX_ANI                 ADC_CTL_CH3
